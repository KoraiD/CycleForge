...
We, as contributors and maintainers of CycleForge, pledge to make participation
...
(examples: using an official e-mail address, posting via an official social
...
the repository's security advisory, or contact the maintainer through their
GitHub profile). All complaints will be reviewed and investigated promptly and
fairly, and will be handled with confidentiality.
